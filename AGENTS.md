...
- Update `activeContext.md` and `progress.md` at minimum whenever work is completed.
- Add extra files under `memory-bank/` when the app grows enough to justify focused docs.
